...
var $author$project$Introduction$Root$Basic_NoTouch = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Introduction$Root$toExample = function (slug) {
	switch (slug) {
		...
		case 'basic-no-touch':
			return $author$project$Introduction$Root$Basic_NoTouch($author$project$Introduction$Basic_NoTouch$initialModel);
		case 'basic-elm-ui':
...
var $author$project$Introduction$Root$Basic_NoTouchMsg = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Introduction$Root$subscriptions = function (model) {
	switch (model.$) {
		...
		case 1:
			...
			return A2(
				$elm$core$Platform$Sub$map,
				$author$project$Introduction$Root$Basic_NoTouchMsg,
...
var $author$project$Introduction$Root$stepBasic_NoTouch = function (_v0) {
	var mo = _v0.a;
	var cmds = _v0.b;
	return _Utils_Tuple2(
		$author$project$Introduction$Root$Basic_NoTouch(mo),
		A2($elm$core$Platform$Cmd$map, $author$project$Introduction$Root$Basic_NoTouchMsg, cmds));
};
			...
			switch (_v0.a.$) {
				...
				case 1:
					if (_v0.b.$ === 1) {
						var msg = _v0.a.a;
						var mo = _v0.b.a;
						return $author$project$Introduction$Root$stepBasic_NoTouch(
...
var $author$project$Introduction$Root$info = function (example) {
	switch (example.$) {
		...
		case 1:
			return {aG: 'Plain sortable list, no touch support', aK: 'basic-no-touch', aA: 'Basic (no touch)'};
		case 2:
				...
				A2(
					...
					_List_fromArray(
						[
							...
							$author$project$Introduction$Root$Basic_NoTouch($author$project$Introduction$Basic_NoTouch$initialModel),
