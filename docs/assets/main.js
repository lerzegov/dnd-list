	...
	function (_v0, msg, _v1, list) {
		...
		switch (msg.$) {
			case 0:
				...
				return _Utils_Tuple2(
					$elm$core$Maybe$Just(
						{y: xy, j: 0, R: $elm$core$Maybe$Nothing, aq: dragElementId, ba: dragIndex, ab: $elm$core$Maybe$Nothing, ac: dragElementId, cV: dragIndex, a0: pointerCaptureEvent, J: xy}),
					list);
			case 1:
				return _Utils_Tuple2(
					A2(
			...
			case 4:
				...
				if ((!_v3.a.$) && (!_v3.b)) {
					var state = _v3.a.a;
					var _v4 = _v3.b;
					return ((state.j > 1) && (!_Utils_eq(state.ba, dropIndex))) ? _Utils_Tuple2(
						$elm$core$Maybe$Just(
	...
	function (_v0, msg, _v1, list) {
		...
		switch (msg.$) {
			...
			case 4:
				...
				if (!model.$) {
					var state = model.a;
					if ((state.j > 1) && (!_Utils_eq(state.ba, dropIndex))) {
...
var $author$project$Config$Movement$Root$url = function (id) {
	switch (id) {
		case 0:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Config/Movement/FreeOnDrag.elm';
		case 1:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Config/Movement/FreeOnDrop.elm';
		case 2:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Config/Movement/HorizontalOnDrag.elm';
		case 3:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Config/Movement/HorizontalOnDrop.elm';
		case 4:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Config/Movement/VerticalOnDrag.elm';
		case 5:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Config/Movement/VerticalOnDrop.elm';
		default:
			return '';
	}
};
var $author$project$Config$OperationsOnDrag$Root$url = function (id) {
	switch (id) {
		case 0:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Config/OperationsOnDrag/InsertAfter.elm';
		case 1:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Config/OperationsOnDrag/InsertBefore.elm';
		case 2:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Config/OperationsOnDrag/Rotate.elm';
		case 3:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Config/OperationsOnDrag/Swap.elm';
		case 4:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Config/OperationsOnDrag/Unaltered.elm';
		default:
			return '';
	}
};
var $author$project$Config$OperationsOnDrop$Root$url = function (id) {
	switch (id) {
		case 0:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Config/OperationsOnDrop/InsertAfter.elm';
		case 1:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Config/OperationsOnDrop/InsertBefore.elm';
		case 2:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Config/OperationsOnDrop/Rotate.elm';
		case 3:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Config/OperationsOnDrop/Swap.elm';
		case 4:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Config/OperationsOnDrop/Unaltered.elm';
		default:
			return '';
	}
};
...
var $author$project$ConfigGroups$OperationsOnDrag$Root$url = function (id) {
	switch (id) {
		case 0:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/ConfigGroups/OperationsOnDrag/InsertAfter.elm';
		case 1:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/ConfigGroups/OperationsOnDrag/InsertBefore.elm';
		case 2:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/ConfigGroups/OperationsOnDrag/Rotate.elm';
		case 3:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/ConfigGroups/OperationsOnDrag/Swap.elm';
		default:
			return '';
	}
};
var $author$project$ConfigGroups$OperationsOnDrop$Root$url = function (id) {
	switch (id) {
		case 0:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/ConfigGroups/OperationsOnDrop/InsertAfter.elm';
		case 1:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/ConfigGroups/OperationsOnDrop/InsertBefore.elm';
		case 2:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/ConfigGroups/OperationsOnDrop/Rotate.elm';
		case 3:
			return 'https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/ConfigGroups/OperationsOnDrop/Swap.elm';
		default:
			return '';
	}
};
...
var $author$project$Gallery$Root$codeView = function (model) {
	switch (model.$) {
		case 0:
			return $author$project$Gallery$Root$toCode('https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Gallery/Hanoi.elm');
		case 1:
			return $author$project$Gallery$Root$toCode('https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Gallery/Puzzle.elm');
		case 2:
			return $author$project$Gallery$Root$toCode('https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Gallery/Shapes.elm');
		case 3:
			return $author$project$Gallery$Root$toCode('https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Gallery/Knight.elm');
		case 4:
			return $author$project$Gallery$Root$toCode('https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Gallery/TryOn.elm');
		default:
			return $author$project$Gallery$Root$toCode('https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Gallery/TaskBoard.elm');
	}
};
...
var $author$project$Introduction$Root$codeView = function (model) {
	switch (model.$) {
		case 0:
			return $author$project$Introduction$Root$toCode('https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Introduction/Basic.elm');
		case 1:
			return $author$project$Introduction$Root$toCode('https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Introduction/BasicElmUI.elm');
		case 2:
			return $author$project$Introduction$Root$toCode('https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Introduction/Handle.elm');
		case 3:
			return $author$project$Introduction$Root$toCode('https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Introduction/Keyed.elm');
		case 4:
			return $author$project$Introduction$Root$toCode('https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Introduction/Margins.elm');
		case 5:
			return $author$project$Introduction$Root$toCode('https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Introduction/Masonry.elm');
		case 6:
			return $author$project$Introduction$Root$toCode('https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Introduction/Resize.elm');
		case 7:
			return $author$project$Introduction$Root$toCode('https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Introduction/Independents.elm');
		default:
			return $author$project$Introduction$Root$toCode('https://raw.githubusercontent.com/ceddlyburge/dnd-list/master/examples/src/Introduction/Groups.elm');
	}
};
...
var $author$project$Gallery$Hanoi$draggableStyles = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'touch-action', 'none')
	]);
				...
				if (_Utils_eq(globalIndex, dragIndex)) {
					return A2(
						...
						A2(
							...
							_Utils_ap(
								A2($author$project$Gallery$Hanoi$diskStyles, width, color),
								_Utils_ap($author$project$Gallery$Hanoi$placeholderStyles, $author$project$Gallery$Hanoi$draggableStyles))),
						_List_Nil);
				} else {
					return A2(
						$elm$html$Html$div,
						A2(
							...
							_Utils_ap(
								A2($author$project$Gallery$Hanoi$diskStyles, width, color),
								$author$project$Gallery$Hanoi$draggableStyles)),
						_List_Nil);
				}
			}
		} else {
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aU: closing, k: _List_Nil, V: _List_Nil, I: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								k: A2(
									$elm$core$List$cons,
									{aU: '\n}', k: _List_Nil, V: props, I: '@supports (' + (prop + (':' + (value + (') {' + parent.I))))},
									rendered.k)
							});
					case 4:
						var selector = rule.a;
